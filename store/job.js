export const state = () => ({
  ...
  jobs: [
    {id: 1, name: 'Fronted developer Intern', cid: [2, 3, 6], salary: 'RM 750 - 1000', company: 1},
    ...
    {id: 6, name: 'Fronted developer', cid: [1, 2, 5, 7], salary: 'RM 750 - 1000', company: 2},
    {id: 10, name: 'Fronted developer', cid: [1, 2, 5, 7], salary: 'RM 750 - 1000', company: 2},
    {id: 3, name: 'UI/UX designer', cid: [2, 5, 6, 8], salary: 'RM 4500', company: 3},
    {id: 7, name: 'Fronted developer Freelancar', cid: [2, 4, 6], salary: 'RM 750 - 1000', company: 3},
    {id: 4, name: 'Game Developer', cid: [5, 6], salary: 'RM 5000-6000', company: 4},
    {id: 8, name: 'Fronted developer Intern', cid: [2, 3, 6], salary: 'RM 750 - 1000', company: 4},
